!Stahl 23/02/2021 Introduce tag to differential dipolar DM from baryons
 ...
 subroutine init_part
  ...
  real(dp)::dx,xx1,xx2,xx3,vv1,vv2,vv3,mm1,tt !23/01/2021 Stahl: to get the tag
    ...
    if(TRIM(initfile(levelmin)).NE.' ')then
       ...
       do while (.not.eof)
          ...
          if(myid==1)then
             jpart=0
             do i=1,nvector
                read(10,*,end=111)xx1,xx2,xx3,vv1,vv2,vv3,mm1,tt
                jpart=jpart+1
                indglob=indglob+1
                xx(i,1)=xx1+boxlen/2
                xx(i,2)=xx2+boxlen/2
