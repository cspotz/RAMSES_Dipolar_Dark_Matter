recursive subroutine amr_step(ilevel,icount)
        ...
        do i=ilevel,nlevelmax
           if(i>levelmin)then
              ...
              if(poisson)then
                 ...
                 call make_virtual_fine_dp(pi_b_mod(1),i)
                 call make_virtual_fine_dp(w_pol_p(1),ilevel) !dipolar dark matter 08/03/21
                 do idim=1,ndim
  ...
  if(poisson)then
     ...
     call save_w_old(ilevel)                           !!!!!!!!!!!!!!!!!!!!!dipolar DM, save old
     call save_pi_old(ilevel)                           !!!!!!!!!!!!!!!!!!!!!dipolar DM, save old
  ...
  if(poisson)then
    ...
    if(ilevel>levelmin)then
     ...
     if (nstep==0)call save_w_old(ilevel)                           !!!!!!!!!!!!!!!!!!!!!dipolar DM, save old
     if (nstep==0)call save_pi_old(ilevel)
